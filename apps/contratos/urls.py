...
from .views import Financeiro_do_Contrato_Aluguel_EXCLUR
...
urlpatterns = [
    ...
    path('contratos/aluguel/detalhes/editar/<int:pk>', Baixa_de_Parcela_Aluguel.as_view(), name='financeiro-do-contrato-editar'),
    path('contratos/aluguel/detalhes/excluir/<int:pk>', Financeiro_do_Contrato_Aluguel_EXCLUR.as_view(), name='financeiro-do-contrato-aluguel-excluir'),
