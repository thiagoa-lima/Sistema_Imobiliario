...
from .views import AdministracaoList, AluguelList, Receita_Alugueis_List, Lista_parcela_aluguel
...
urlpatterns = [
    ...
    path('receitas/alugueis/listar/', Receita_Alugueis_List.as_view() ,name='receitas-alugueis-listar' ),
